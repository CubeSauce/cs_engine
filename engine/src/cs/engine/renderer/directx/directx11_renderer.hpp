...
public:
    ...
    virtual void draw_mesh_instanced(const Shared_Ptr<Mesh>& mesh, const Dynamic_Array<Instance_Data>& instance_datas, VR_Eye::Type eye = VR_Eye::None) override;
